...
export default function ContactHero({ language, isDarkMode }: ContactHeroProps) {
  // Section content
  ...
  const subtitle = language === "fr"
    ? "Notre équipe est prête à répondre à toutes vos questions sur l'IA française."
    : "Our team is ready to answer all your questions about French AI.";
      ...
      <div className="relative max-w-5xl mx-auto text-center px-4">
        <div className="flex justify-center mb-6">
          <div className="p-3 bg-indigo-600/10 rounded-xl">
            <MessageSquare className="text-indigo-500" size={30} />
          </div>
        </div>
